...
Two end-to-end deep learning pipelines for intrusion detection on TON_IoT data. Each pipeline includes data loading, preprocessing, training, evaluation, and transfer learning.
...
Outputs
Each pipeline writes trained models, preprocessing artifacts, classification reports, and confusion matrices to its respective results folder.